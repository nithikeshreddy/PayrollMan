    ...
    >
      {({ isActive }) => (
        <>
          ...
          {isActive && <ChevronRight className="w-3.5 h-3.5 ml-auto text-indigo-600/60" />}
        </>
      )}
    </NavLink>
  );
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-200">
          ...
          <div>
            <p className="text-sm font-bold text-slate-900 leading-none">WorkTracker</p>
        ...
        <div className="px-3 py-4 border-t border-slate-200">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-100/60 cursor-pointer group">
            ...
            <button
              ...
              className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-lg hover:bg-rose-600/10 text-slate-400 hover:text-rose-600"
              title="Sign out"
            >
